...
`rollbarrel` is centered on automation work in Go. The technical target is: Plan backup retention and dry-run deletion reports.
...
The score is deterministic. The current threshold is 150. Risk has a penalty of 5, latency has a penalty of 3, and weight contributes a bonus of 6.
