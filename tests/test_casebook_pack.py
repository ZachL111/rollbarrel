"""Regression checks for the rollbarrel casebook."""
...
from casebook.harness import assert_expected, rollbarrel_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(rollbarrel_summary(), assert_expected())
